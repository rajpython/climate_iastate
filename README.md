...
- **[Runtime Architecture](docs/technical/architecture_runtime.md)** — Entry points, data artifacts, refresh flow, and service runtime
- **[Dashboard Wireframe](docs/technical/dashboard_wireframe.md)** — UI layout specification
